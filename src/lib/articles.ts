...
export const articlesRegistry: Record<string, ArticleData> = {
  "transisi-pembukuan-digital": {
    ...
    title: "Panduan Komprehensif Transisi dari Pembukuan Manual ke Sistem Digital Tanpa Selisih Data",
    subtitle: "Metodologi bertahap bagi pemilik usaha dan tim akuntansi untuk memindahkan pencatatan dari kwitansi fisik dan spreadsheet ke sistem otomatis tanpa mengganggu operasional harian.",
    category: "Panduan Pembukuan",
    readTime: "10 min read",
    author: "Tim Akuntansi & Produk Siarpi",
    publishedDate: "20 Juli 2026",
    summary: "Memindahkan sistem pembukuan dari kertas atau spreadsheet ke aplikasi otomatis sering kali menimbulkan kekhawatiran akan terjadinya selisih kas atau hilangnya histori data. Panduan ini membahas metodologi transisi aman melalui metode penetapan tanggal potong saldo dan uji coba sistem paralel.",
    sections: [
      {
        id: "latar-belakang",
      ...
      },
      {
        ...
        keyTakeaway: "Tentukan tanggal potong saldo akhir bulan. Jangan mencoba menginput ulang seluruh data transaksi tahun-tahun sebelumnya pada hari pertama migrasi sistem."
      },
      {
        id: "struktur-coa",
  ...
  "rumus-kas-usaha-harian": {
    ...
    subtitle: "Memahami perbedaan profit di atas kertas dengan ketersediaan uang tunai nyata, serta cara menghitung rasio likuiditas untuk mencegah krisis modal kerja.",
    category: "Tips Akuntansi",
    readTime: "8 min read",
    author: "Tim Akuntansi & Produk Siarpi",
    publishedDate: "18 Juli 2026",
    summary: "Banyak perusahaan yang mencatatkan pertumbuhan penjualan dan laba bersih di atas kertas namun mengalami kesulitan keuangan karena arus kas yang tersendat. Artikel ini mengurai lima indikator harian yang wajib dipantau pemilik usaha untuk menjaga likuiditas.",
    sections: [
      {
        id: "pentingnya-kas",
      ...
      },
      {
        ...
        keyTakeaway: "Disiplin menagih piutang yang hampir jatuh tempo jauh lebih efektif menambah arus kas dibanding terus memperbesar omset penjualan kredit."
      }
    ],
    faq: [
      {
  ...
  "otomatisasi-efaktur-ppn": {
    ...
    subtitle: "Cara menyelaraskan pencatatan PPN Masukan dan PPN Keluaran agar siap diimpor ke aplikasi DJP Online tanpa selisih dan bebas dari denda keterlambatan.",
    category: "Pajak & Valuta",
    readTime: "9 min read",
    author: "Tim Pajak & Akuntansi Siarpi",
    publishedDate: "15 Juli 2026",
    summary: "Menyusun Faktur Pajak PPN dan mencocokkan bukti potong di akhir masa pajak sering kali menyita waktu tim akuntansi. Pelajari cara menyelaraskan data transaksi akuntansi dengan format impor e-Faktur DJP secara otomatis.",
    sections: [
      {
        id: "alur-pajak",
