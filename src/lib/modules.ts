import {
  ...
  BookOpen, Building2, Receipt, CreditCard, Box,
  Percent, Globe, PieChart, FileSpreadsheet, Settings,
  type LucideIcon,
} from "lucide-react";
...
export const modules = [
  ...
  { id: "finance", name: "Finance & Akuntansi", iconName: "LineChart", description: "Akuntansi ganda, jurnal, kas/bank, pajak, aset & kurs BI", price: 99000 },
...
// ── Registry Sub-Modul Detail Finance (Mudah Di-maintain) ──────────
export const financeSubModules: FinanceSubModule[] = [
  {
    ...
    description: "Pencatatan entri jurnal umum, penyesuaian, penutup, dan mutasi Buku Besar per Chart of Accounts (COA).",
    frontendPath: "app/pages/finance/jurnal/*",
    backendPath: "siarpi-backend/finance/coa/*",
    subFeatures: ["Jurnal Umum & Template", "Multi-Cost Center", "Filtering Buku Besar Real-time", "Jurnal Pembalik Otomatis"],
  },
  {
    id: "kas-bank",
    name: "Kas & Bank",
    ...
    description: "Pengelolaan kas masuk, kas keluar, transfer antar rekening bank, dan posting otomatis ke GL.",
    frontendPath: "app/pages/finance/kas-bank/*",
    backendPath: "siarpi-backend/finance/cashbank/*",
    subFeatures: ["Kas Masuk & Kas Keluar", "Transfer Antar Rekening", "Auto-posting ke Buku Besar", "Histori Mutation Log"],
  },
  {
    id: "piutang-ar",
    ...
    iconName: "Receipt",
    category: "Operasional Transaksi",
    description: "Penerbitan faktur penjualan (AR Invoice), penerimaan pembayaran piutang, dan analisis AR Aging.",
    frontendPath: "app/pages/finance/piutang/*",
    backendPath: "siarpi-backend/finance/ar/*",
    subFeatures: ["Faktur Penjualan (AR)", "Penerimaan Pembayaran Piutang", "Analisis AR Aging", "Retur Penjualan"],
  },
  {
    id: "hutang-ap",
    ...
    iconName: "CreditCard",
    category: "Operasional Transaksi",
    description: "Pencatatan faktur pembelian (AP Invoice), pembayaran ke vendor/supplier, dan jadwal jatuh tempo AP Aging.",
    frontendPath: "app/pages/finance/hutang/*",
    backendPath: "siarpi-backend/finance/ap/*",
    subFeatures: ["Purchase Invoice (AP)", "Pembayaran Vendor", "Jadwal AP Aging", "Retur Pembelian"],
  },
  {
    id: "aset-tetap",
    ...
    iconName: "Box",
    category: "Operasional Transaksi",
    description: "Manajemen siklus hidup aset: perolehan, penyusutan otomatis (Garis Lurus & Saldo Menurun), revaluasi, impairment, dan pelepasan.",
    frontendPath: "app/pages/finance/aset/*",
    backendPath: "siarpi-backend/finance/asset/*",
    subFeatures: ["Pencatatan Perolehan Aset", "Penyusutan Massal & Single", "Revaluasi & Impairment", "Pelepasan & Mutasi Aset"],
  },
  {
    id: "pajak",
    ...
    description: "Pengelolaan PPN Masukan/Keluaran, Bukti Potong PPh 21/23/4(2), rekonsiliasi pajak, dan persiapan e-Faktur.",
    frontendPath: "app/pages/finance/pajak/*",
    backendPath: "siarpi-backend/finance/pajak/*",
    subFeatures: ["Faktur Pajak PPN", "Bukti Potong PPh", "Rekonsiliasi Pajak DJP", "Pembayaran Pajak"],
  },
  {
    id: "kurs-valuta",
    ...
    iconName: "Globe",
    category: "Pajak & Valuta",
    description: "Integrasi real-time Bank Indonesia JISDOR & Kurs Transaksi (USD, SGD, EUR, JPY, GBP, AUD, CNY, MYR, SAR, HKD), grafik tren & detail dinamis per negara.",
    frontendPath: "app/pages/finance/kurs/*",
    backendPath: "siarpi-backend/kurs/*",
    subFeatures: ["Real-time BI JISDOR & Kurs Transaksi", "Support Multi-Currency", "Detail Dinamis Per Negara", "Kalkulator Konversi Real-time"],
  },
  {
    id: "budget",
    ...
    description: "Perencanaan anggaran bulanan/tahunan dan monitoring variance realisasi vs anggaran berdasarkan entri Buku Besar.",
    frontendPath: "app/pages/finance/budget/*",
    backendPath: "siarpi-backend/finance/budget/*",
    subFeatures: ["Penganggaran Per Akun COA", "Analisis Variance (Selisih)", "Mode Bulanan & Tahunan", "Insight Realisasi Real-time"],
  },
  {
    id: "laporan",
    ...
    category: "Laporan & Planning",
    description: "Penyusunan laporan standar akuntansi: Neraca (Balance Sheet), Laporan Laba/Rugi (Profit & Loss), Arus Kas (Cash Flow), dan Neraca Saldo (Trial Balance).",
    frontendPath: "app/pages/finance/report/*",
    backendPath: "siarpi-backend/finance/report/*",
    subFeatures: ["Neraca (Balance Sheet)", "Laporan Laba/Rugi", "Laporan Arus Kas", "Trial Balance / Neraca Saldo"],
  },
  {
    id: "pengaturan",
    ...
    iconName: "Settings",
    category: "Akuntansi Utama",
    description: "Kelola Chart of Accounts (COA), Penomoran Dokumen Otomatis, Penguncian Periode Akuntansi, Saldo Awal, dan Konfigurasi Mata Uang.",
    frontendPath: "app/pages/finance/pengaturan/*",
    backendPath: "siarpi-backend/finance/settings/*",
    subFeatures: ["Chart of Accounts (COA)", "Penomoran Dokumen", "Kunci Periode Akuntansi", "Saldo Awal & Sync Kurs BI"],
  },
];
